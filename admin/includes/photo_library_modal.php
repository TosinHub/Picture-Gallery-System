...
<?php $photos = PhotoClass::find_all(); ?>
      ...
      <div class="modal-body">
          <div class="col-md-9">
             <div class="thumbnails row">
                ...
                <?php foreach ($photos as $photo):       # code...
                 ?>


               <div class="col-xs-2">
                 <a role="checkbox" aria-checked="false" tabindex="0" id="" href="#" class="thumbnail">
                   <img data="<?php echo $photo->id; ?>"  class="modal_thumbnails img-responsive" src="<?php echo $photo->picture_path(); ?>" data="<!-- PHP LOOP HERE CODE HERE-->">
                 </a>
