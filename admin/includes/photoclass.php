...
class PhotoClass extends Db_object
{
    protected static $db_table = "photos";
    protected static $db_table_fields  = array('title','caption','description','filename','alternative_text','type','size');
    public $id;
    public $title;
    public $description;
    public $caption;
   ...
   public static function display_sidebar_data($photo_id){
       $photo = PhotoClass::find_by_id($photo_id);

       $output = "<a class='thumbnail' href=''><img width='200px' height='200px' src='{$photo->picture_path()}' /></a>";
