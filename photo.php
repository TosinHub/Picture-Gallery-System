<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $new_comment = CommentClass::create_comment($photo->id,$author,$body);
    ...
    $comments = CommentClass::find_the_comments($photo->id);
                ...
                <div class="well">
                    ...
                    <form role="form" method="post">
                        <div class="form-group">
                            <input class="form-control" type="text" name="author" placeholder="Author" id="">
                        </div>
                        <div class="form-group">
